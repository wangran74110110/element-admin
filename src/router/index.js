...
export const constantRoutes = [
  ...
  //   path: '/material',  //路由路径
  //   component: Layout, //嵌入的父类模板
  //   redirect: '/material/images',  //重定向的路由
  //   name: 'material',  //路由名称
  //   meta: { title: '素材管理', icon: 'student' },
  //   children: [
  //     {
  //       path: 'images',
  //       name: 'materialImages',  //二级路由 设置名字最好带上一级路由的名字
  ...
  //   path: '/content',  //路由路径
  //   component: Layout, //嵌入的父类模板
  //   redirect: '/content/article',  //重定向的路由
  //   name: 'content',  //路由名称
  //   meta: { title: '内容管理', icon: 'example' },
  //   children: [
  //     {
  //       path: 'article',
  //       name: 'contentArticle',  //二级路由 设置名字最好带上一级路由的名字
